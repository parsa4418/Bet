...
def _start_diamond_hunt(chat_id):
    try:
        ...
        # ویرایش پیام برای اضافه کردن دکمه
        safe_edit_message(
...
def _user_display_from_call(call):
    ...
    if call.from_user.username:
        return f"{name} (@{call.from_user.username})"
    return name
    ...
    with diamond_hunt_lock:
        ...
        if won:
            ...
            try:
                ...
                # ✅ ارسال عکس به جای پیام متنی
                bot.send_photo(
                    chat_id,
                    photo="https://i.ibb.co/TDMk6NZz/file-00000000aa6481f7a219e1184b4dd639.jpg",  # عکس تبریک
                ...
                # پیام قبلی رو با یه متن ساده جایگزین کن
                safe_edit_message("✅ الماس برداشته شد!", chat_id, message_id, reply_markup=None)
