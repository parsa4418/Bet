...
def _jewelry_build_markup(user_id):
    ...
    buttons = [
        types.InlineKeyboardButton("1 انگشتر 💍", callback_data=f"jewel_build|{user_id}|1"),
        types.InlineKeyboardButton("2 انگشتر 💍", callback_data=f"jewel_build|{user_id}|2"),
        types.InlineKeyboardButton("3 انگشتر 💍", callback_data=f"jewel_build|{user_id}|3"),
        types.InlineKeyboardButton("5 انگشتر 💍", callback_data=f"jewel_build|{user_id}|5"),
