...
def _start_diamond_hunt(chat_id):
    try:
        photo_url = "https://i.postimg.cc/NMDLj4qv/IMG-20260824-133656-138.jpg"
    ...
    with diamond_hunt_lock:
        ...
        if won:
            ...
            try:
                ...
                bot.send_photo(
                    chat_id,
                    photo="https://i.postimg.cc/NMDLj4qv/IMG-20260824-133656-138.jpg",
                ...
                try:
                    ...
                    safe_edit_message("✅", chat_id, message_id, reply_markup=None)
